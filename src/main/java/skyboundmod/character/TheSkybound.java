...
import static skyboundmod.SkyboundMod.characterPath;
import static skyboundmod.SkyboundMod.makeID;

public class TheSkybound extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("TheSkybound"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass SKYBOUND;
        @SpireEnum(name = "SKYBOUND") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "SKYBOUND") @SuppressWarnings("unused")
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new TheSkybound(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
